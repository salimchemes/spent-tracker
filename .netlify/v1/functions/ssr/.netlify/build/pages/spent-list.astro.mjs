...
const $$ListSpent = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md" data-astro-cid-chm636uw> <div class="overflow-x-auto" data-astro-cid-chm636uw> <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700" data-astro-cid-chm636uw> <thead class="bg-gray-50 dark:bg-gray-700" data-astro-cid-chm636uw> <tr data-astro-cid-chm636uw> <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider" data-astro-cid-chm636uw>Date</th> <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider" data-astro-cid-chm636uw>Category</th> <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider" data-astro-cid-chm636uw>Amount</th> <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider" data-astro-cid-chm636uw>Payment Type</th> <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider" data-astro-cid-chm636uw>Created By</th> <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider" data-astro-cid-chm636uw>Notes</th> <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider" data-astro-cid-chm636uw>Actions</th> </tr> </thead> <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700" data-astro-cid-chm636uw> ${!spentItems || spentItems.length === 0 ? (
    // if no records show no records added yet in a
    renderTemplate`<tr data-astro-cid-chm636uw> <td colspan="6" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300 text-center" data-astro-cid-chm636uw>
...
$${item.amount.toFixed(2)} </td> <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300 capitalize" data-astro-cid-chm636uw> ${item.paymentType} </td>${" "} <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300 capitalize" data-astro-cid-chm636uw> ${item.createdBy} </td> <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300 capitalize" data-astro-cid-chm636uw> ${item.notes} </td> <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300 flex space-x-2" data-astro-cid-chm636uw>  <button class="remove-btn text-blue-600 hover:text-blue-900"${addAttribute(item.id, "data-id")}${addAttribute(spentItems, "data-items")} data-astro-cid-chm636uw>
Remove
